- dashboard: pin2kba
  title: PET PIN Authentication PIN2KBA
  layout: newspaper
  load_configuration: wait
  elements:
  - name: Customer Authentication Metrics PIN2KBA table
    title: Customer Authentication Metrics PIN2KBA table
    model: cda_domain
    ...
    width: 19
    height: 9
  - name: Customer Authentication Metrics PIN2KBA Chart Total
    title: Customer Authentication Metrics PIN2KBA Chart Total
    model: cda_domain
    explore: authentication_user_event
    type: looker_bar
    fields: [authentication_user_event.reference_date, authentication_user_event.registration,
      ...
      authentication_user_event.attempted]
    filters:
      authentication_user_event.pin_type: PIN2KBA
    ...
    y_axes: [{label: '', orientation: bottom, series: [{axisId: authentication_user_event.registration,
        ...
        type: linear}]
    hidden_series: [authentication_user_event.eligible, authentication_user_event.optedin,
      authentication_user_event.p2t_not_eligible, authentication_user_event.attempted]
    font_size: '12'
    series_types: {}
    show_dropoff: false
    ...
    width: 5
    height: 9
  - name: Customer Authentication Metrics PIN2KBA Chart
    title: Customer Authentication Metrics PIN2KBA Chart
    model: cda_domain
    explore: authentication_user_event
    type: looker_column
    fields: [authentication_user_event.reference_date, authentication_user_event.registration,
