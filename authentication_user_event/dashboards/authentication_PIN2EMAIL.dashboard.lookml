- dashboard: pin2email
  title: PET PIN Authentication PIN2EMAIL
  layout: newspaper
  load_configuration: wait
  elements:
  - name: Customer Authentication Metrics PIN2EMAIL table
    title: Customer Authentication Metrics PIN2EMAIL table
    model: cda_domain
    ...
    width: 18
    height: 9
  - name: Customer Authentication Metrics PIN2EMAIL Chart Total
    title: Customer Authentication Metrics PIN2EMAIL Chart Total
    model: cda_domain
    explore: authentication_user_event
    type: looker_bar
    fields: [authentication_user_event.reference_date, authentication_user_event.registration,
      ...
      authentication_user_event.p2t_not_eligible]
    filters:
      authentication_user_event.pin_type: PIN2EMAIL
    ...
    width: 6
    height: 9
  - name: Customer Authentication Metrics PIN2EMAIL Chart
    title: Customer Authentication Metrics PIN2EMAIL Chart
    model: cda_domain
    explore: authentication_user_event
    type: looker_column
    fields: [authentication_user_event.reference_date, authentication_user_event.registration,
    ...
    show_silhouette: false
    totals_color: "#808080"
    hidden_series: [authentication_user_event.eligible, authentication_user_event.attempted,
      authentication_user_event.optedin, authentication_user_event.p2t_not_eligible]
    font_size: '12'
    series_types:
