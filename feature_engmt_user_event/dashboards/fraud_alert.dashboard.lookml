- dashboard: fraud_alert
  ...
  - title: Alert Failure Reason by Month
    ...
    limit_displayed_rows_values:
      ...
      first_last: first
      num_rows: 0
    conditional_formatting: [{type: greater than, value: 3300, background_color: "#E57947",
    ...
    width: 10
    height: 7
  - title: Fraud Alerts by Event Date
    name: Fraud Alerts by Event Date
    model: cda_domain
    explore: feature_engmt_user_event
    type: looker_grid
    ...
    filters:
      feature_engmt_user_event.metric_type: '"FRAUD_ALERT"'
    sorts: [feature_engmt_user_event.fa_fraud_eligibility_error]
    limit: 5000
    query_timezone: America/Los_Angeles
    show_view_names: false
    show_row_numbers: false
    ...
    series_cell_visualizations:
      feature_engmt_user_event.fa_active_duty:
        is_active: false
    conditional_formatting: [{type: greater than, value: 190, background_color: "#B32F37",
        font_color: !!null '', color_application: {collection_id: b43731d5-dc87-4a8e-b807-635bef3948e7,
          palette_id: 1e4d66b9-f066-4c33-b0b7-cc10b4810688, options: {constraints: {
              min: {type: minimum}, mid: {type: number, value: 0}, max: {type: maximum}},
            mirror: true, reverse: false, stepped: false}}, bold: false, italic: false,
        strikethrough: false, fields: [feature_engmt_user_event.fa_total_failures]}]
